...
class Actor(object):
    ...
    def build_reward(self):
        ...
        with tf.name_scope('permutations'):
            ...
            e = Environment(self.ordered_input_)
            self.distances = e.get_distance()
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for i in tqdm(range(nb_epoch)): # epoch i
            ...
            permutation, distances, pointing = sess.run([actor.positions, actor.distances, actor.pointing], feed_dict=feed)
            print(' Permutation \n',permutation)
            print(' Tour length \n',distances)
